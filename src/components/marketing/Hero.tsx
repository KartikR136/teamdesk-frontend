...
const MOCK_ISSUES = [
  ...
  {
    title: "Add cursor-based pagination to /issues",
    status: "in_progress",
    priority: "urgent",
  },
  {
    title: "Cross-org IDOR regression test",
    status: "in_review",
    priority: "high",
  },
  {
    title: "Decision log — status change audit event",
    status: "todo",
    priority: "medium",
  },
  {
    title: "Rate-limiter per-route granularity",
    status: "todo",
    priority: "low",
  },
];
  ...
  return (
    ...
    >
            ...
            {[
              ...
              <div
                ...
                className={cn(
                  ...
                  active ? "bg-primary-subtle text-primary" : "text-text-muted",
                )}
              >
                {icon}
                {label}
      ...
      >
        ...
        <p className="text-lg font-bold text-success tracking-tight">
          Verified ✓
        </p>
      </motion.div>
    ...
    <section className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-16 pb-12 sm:pt-24 sm:pb-20 overflow-hidden">
      ...
      <div className="relative grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          >
            Ship faster. <span className="text-primary">Stay accountable.</span>
            <br />
            Never lose context.
          </motion.h1>
          ...
          >
            A focused engineering-ops workspace — issues, decisions, and
            deployments in one place, built on multi-tenant security that&amp;s
            tested against real attack scenarios, not just described in a doc.
          </motion.p>
          ...
          >
            {[
              ...
              {
                label: "14 attack scenarios tested",
